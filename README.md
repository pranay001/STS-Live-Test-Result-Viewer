...
1. Download the <a href="https://github.com/pranay001/STS-Live-Test-Result-Viewer/releases" target="_blank">latest release</a> of STS Live Test Result Viewer (`STS_LiveTestResultViewer_Release vx.x.x.zip`)
